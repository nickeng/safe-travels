...
| The ask | The guide |
|---|---|
| _"New York City in October, I've been 100 times, show me the side the locals love"_ | [guide](./samples/new-york-city.html) |
| _"Annapurna circuit, it's my first major trek"_ | [guide](./samples/annapurna.html) |
| _"I want to see Antarctica. When is the best time to go? How do I even get there?"_ | [guide](./samples/antarctica.html) |
| _"I want to see a puffin"_ | [guide](./samples/puffin.html) |
| _"RV family road trip, plan a drive from Sea-Tac to Whistlers Campground. I have 2 daughters in high school who won't take a hike more than 30 min without complaining to high hell."_ | [guide](./samples/seattle-jasper.html)|
| _"Visiting Chengdu in August with our 1 year old"_ | [guide](./samples/chengdu.html) |
| _"I want to do a garden tour in the Netherlands, April or May"_ | [guide](./samples/netherlands.html) |
| _"Going to see the Augusta Masters with friends"_ | [guide](./samples/augusta-masters.html) |
| _"I want to walk the Camino de Santiago, the last 100km"_ | [guide](./samples/camino.html) |
| _"Sahara desert from Marrakech, I want the real desert experience, no glamping"_ | [guide](./samples/sahara.html) |
| _"Around the world in 80 days, just like Phileas Fogg"_ | [guide](./samples/80-days.html) |
